...
background-color: #fff;
    ...
    box-shadow: 0px 0px 10px -1px rgba(33, 54, 107, 0.82);
}
</style>
<div class="wrapper">
         ...
         <div class="col-sm-12">
            <div class="page-title-box" style="margin-top: 1%!important;">
               <div class="btn-group pull-right">
                  ...
                  <a href="{{ URL::previous() }}"><i class="fa fa-arrow-left" style="color: #21366b; margin-right: 8px;border: 2px solid;padding: 5px;border-radius: 17px;margin-top: 10%;"></i><span style="color: #21366b; font-size: large; margin-right: 15px;">Back</span></a>
               </div>
               <div class="pull-left">
      ...
      <div class="row">
         <div class="col-md-3 mb-3">
            <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
               ...
               <li class="nav-item">
                  <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#addon" role="tab" aria-controls="addon" aria-selected="false"><i class="fa fa-plus iconfa" aria-hidden="true"></i>Add on Features</a>
               </li>
               <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
               <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  <div class="col-md-12 vimkim">
                    ...
                    <input type="text" id="vehicle_id" value="{{ $vehicle_id }}" />
                  </div>
                  <div class="form-row formtab">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input data-parsley-type="number" type="date" class="form-control tribut" maxlength="10" required value="{{ $vehicle_info[0] ->vehicle_reg_year }}" placeholder="Date" id="vehicle_reg_year" />
                     </div>
                     <div class="form-group col-md-6">
                        <label>Insurancer Date</label>
                        <input data-parsley-type="number" type="date" class="form-control tribut" maxlength="10" required value="{{ $vehicle_info[0] ->vehicle_insurance }}" placeholder="Date" id="vehicle_insurance" />
                     </div>
                     <div class="form-group col-md-6">
                        <label>FC Date</label>
                        <input data-parsley-type="number" type="date" class="form-control tribut" maxlength="10" required value="{{ $vehicle_info[0] ->vehicle_fc_date }}" placeholder="Date" id="vehicle_fc_date" />
                     </div>
                     <div class="form-group col-md-6">
                  ...
                  <div class="form-row formtab">
                     <div class="form-group">
                        ...
                        <input type="text" id="partner_id" value="{{ Session::get('user_id') }}">
               ...
               <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="form-row formtab">
                    ...
                    <center><div id="calendar" style="width: 90%; display: inline-block;"></div></center>
                  </div>
               </div>
                  ...
                  <div class="col-md-12 vimkim">
                    ...
                    <div class="form-row formtab">
                        ...
                        <div class="form-group col-md-6">
                         ...
                         @if(count($vehicle_img) != '')
                        <div class="resCarousel" data-items="2-3-3-3" data-slide="3" data-speed="900" data-animator="lazy">
                            <div class="resCarousel-inner">
                                @foreach($vehicle_img as $vehimg)
                                <div class="item">
                                   <div class="col-item itempro">
                                      <div class="photo">
                                    @if(file_exists($vehimg->file_url))
                                    <img src="{{ $vehimg->file_url }}" class="img-responsive" style="width: 300px; height: 195px;" />
                                    @else
                                    <img src="{{'..//upload/partner/'.$vehimg->partner_id.'/vehicle_images/'.$vehimg->vehicle_id.'/'.$vehimg->file_orginal_name}}" class="img-responsive" style="width: 300px; height: 195px;" />    
                                    @endif
                                      ...
                                      <div class="info">
                                         <div class="row">
                                            <div class="col-md-2">
                                               <div class="path-6-copy-2"></div>
                                               <br>
                                               <div class="path-6-copy"></div>
                                            </div>
                                         </div>
                                      </div>
                                   </div>
                            ...
                            <button class='btn btn-default leftRs'><i class="fa fa-long-arrow-left win"></i></button>
                            <button class='btn btn-default rightRs'><i class="fa fa-long-arrow-right win"></i></button>
                        </div>
                        @else
                        <p> 
               ...
               <div class="tab-pane fade" id="addon" role="tabpanel" aria-labelledby="contact-tab">
                  ...
                  <div class="form-row formtab">
                     <div class="form-group col-md-4" id="add_on_features">
                       <label for="option_name">Add on Features</label><br>
                          @foreach($add_on_features as $af)
                          <label>
                          <input type="checkbox" name="option_name[]" id="option_name" onclick="myFunction()" value="{{ $af->master_data_id }}">
                          <label>{{ ucfirst($af->master_key) }}</label>
                          </label>
                          <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="value" id="addon_value" />
                          @endforeach
                    </div>
                  ...
                  <div class="col-md-12 vimkim">
                     <h4 class="customdet">Add on Services</h4>
                          ...
                          <form>
                             <div class="form-row">
                                <div class="form-group col-md-4">
                                   ...
                                   <input data-parsley-type="number" type="text" class="form-control tribut" required placeholder="name the services" id="add_service" />
                                </div>
                                <div class="form-row formtab">
                                   <div class="form-group">
                                      <input type="hidden" id="csrf_token" value="{!! csrf_token() !!}">
                  ...
                  <div class="form-row formtab">
                     <div class="form-group col-md-4" id="add_on_services">
                       <label for="option_name1">Add on Services</label><br>
                          @foreach($add_on_services as $as)
                          <input type="checkbox" name="option_name1[]" id="option_name1" onclick="myFunction()" value="{{ $as->master_data_id }}">
                          <label>{{ ucfirst($as->master_data_id) }}{{ ucfirst($as->master_key) }}</label>
                          @endforeach
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group col-md-6">
                        <?php
                            $uploaded_doc_info = DB::table('document_details')
                                        ...
                                        ->where('file_for','general_document')
                                        ->get();
                        ?>
...
$("#update_bacic_info_submit").click(function(){
        ...
        var vehicle_id = $('#vehicle_id').val();
        var tempcsrf = $('#csrf_token').val();
        if((vehicle_model =='')||(vehicle_brand =='')||(vehicle_reg_no =='')||(vehicle_ac_type =='')||(vehicle_max_speed =='')||(vehicle_running_km =='')||(vehicle_reg_year =='')||(vehicle_seat_type =='')||(vehicle_seat_count =='')||(available_status =='')||(vehicle_condition =='')||(vehicle_color =='')||(vehicle_fuel_type =='')||(vehicle_driving_type =='')){
            $.alert({
                title: 'Alert!',
                content: "Please fill all mandatory fields !!!",
            });
...
//   alert(inserted_vehicle_id);
   ...
   var extraObj1 = $("#fileuploader").uploadFile({
       ...
       formData: {
            partner_id: partner_id,
            vehicle_id: vehicle_id,
            general_file_for: general_file_for,
   ...
   var extraObj4 = $("#imag_uploader").uploadFile({
       dataType: 'json',
      url:"{{ url('upload_vehicle_document111') }}",
       fileName:"myfile",
       formData: {
            partner_id: partner_id,
            vehicle_id: vehicle_id,

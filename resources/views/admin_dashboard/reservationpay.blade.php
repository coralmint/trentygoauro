...
<div class="wrapper">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Payment Details</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Admin Section</a>
  </li>
  <li class="nav-item">
                        ...
                        <option value="3">Paypal</option>
                         <option value="3">Google Pay</option>
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="Enter Coupon Code" id="color_code" />             
                                          </div>
                                            <div class="form-group col-md-6">
                                           
                                            <button type="button" class="btn btn-primary waves-effect waves-light" id="apply" style="background-color:#27c9e1 !important;border:none !important;">Apply</button>            
                                          </div>
                                         <div class="form-group col-md-8">
                                       <label class="checkbox-inline">
                                       <input type="checkbox" value="">Terms and Conditions
                                       </label>
                                    </div>
...
<div class="col-md-12 vimkim">
                                      <h4 class="customdet">Admin Section</h4>
                                      </div>
                                        <div class="form-row formtab">
                                        
                                          <div class="form-group col-md-6">
                                             <label>Partner Name</label>
                                             <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="Partner Name" id="color_name" />             
                                          </div>
                                          <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="Vechile Reg No" id="color_code" />             
                                          </div>
                                          <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group col-md-6">
                                             <label>Vechile Documents</label>
                                             <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="Vechile Documents" id="color_name" />             
                                          </div>
                                               <div class="form-group col-md-6">
                                             <label>Partner Rating</label>
                                             <input data-parsley-type="number" type="text" class="form-control tribut" maxlength="10" required placeholder="Partner Rating" id="color_name" />             
                                          </div>

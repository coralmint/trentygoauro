...
<ul  class="nav nav-pills">
			<li class="active">
        <a  href="#1a" data-toggle="tab">Category 01</a>
			</li>
			<li><a href="#2a" data-toggle="tab">Category 02</a>
			</li>
			<li><a href="#3a" data-toggle="tab">Category 03</a>
			</li>
  		<li><a href="#4a" data-toggle="tab">Category 04</a>
			</li>
		</ul>
...
<div class="col-md-12">
        ...
        <div class="entry-content">
          <a href="">
            <img src="http://placehold.it/750x420" alt="" class="img-fluid" style="width:100%;"/>
          </a>
           <header>
         
          <h2 class="cleart">
            <a href="">
            Titre de l'article</a></h2>
            
             <div class="meta">

            Par trentgo -<span class="author">Date</span>- <span class="date">Category</span>
          </div>
        </header>
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis aliquid fuga dolorum est ab fugit, eveniet quam minus reiciendis harum accusamus a velit, vero impedit, dolor. Sapiente architecto.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis aliquid fuga dolorum est ab fugit, eveniet quam minus reiciendis harum accusamus a velit, vero impedit, dolor. Sapiente architecto</p>

          <a href="#" class="btn btn-primary impedit">En Sovouir Plus<span class="glyphicon glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>
        </div>
        <footer>
        </footer>
      </article>

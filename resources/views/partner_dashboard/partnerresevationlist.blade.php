            ...
            <div class="form-row formtab">
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     ...
                     <label for="vehicle Model">Email Id</label>
                  </div>
               </div>
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     <input type="text" class="form-control" id="reservation_id" placeholder="Location" onfocus="this.placeholder = ''" required autofocus >
                     <label for="Location">Reservation Id</label>
                  </div>
               </div>
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     <input type="text" class="form-control" id="vechicle_id" placeholder="Vehicle Id" onfocus="this.placeholder = ''" required autofocus >
                     <label for="Vehicle Color">Vehicle Id</label>
                  </div>
               </div>
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     <input type="text" class="form-control" id="city" placeholder="Vehicle Id" onfocus="this.placeholder = ''" required autofocus >
                     <label for="Vehicle Color">Location</label>
                  </div>
               </div>
               <div class="form-group col-md-3">
                    <div class="form-group has-float-label">
                       <select class="form-control" id="status" class="form-control" placeholder="" onfocus="this.placeholder = ''" required autofocus>
               ...
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     <div class="input-group">
                        <input type="text" class="form-control" placeholder="Booking From Date" id="start_date">
               ...
               <div class="form-group col-md-3">
                  <div class="form-group has-float-label">
                     <div class="input-group">
                        <input type="text" class="form-control" placeholder="Booking To Date" id="return_date">
                        <div class="input-group-append">
                           <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
...
$(document).ready(function () {
       $(function() {
   	   var table =  $('#reservation_list_datatable').DataTable({
               ...
               "serverSide": false,
   	        ajax: {
   	                url: '{{url('get_all_partner_reservation_list')}}',
    	        ...
    	        ajax: {
    	            ...
    	            dataType: 'json',
    	               cache: false,
    	                ...
    	                url: '{{url('get_all_partner_filter_reservation_list')}}',
    	                error: function (xhr, error, thrown) {
    	                alert(thrown);      
    	              }
    	            },

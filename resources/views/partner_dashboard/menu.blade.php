   ...
   <div class="container-fluid">
      ...
      <div id="navigation" style="margin-top: -6%;">
         ...
         <ul class="navigation-menu" style="margin: 1%;">
            ...
            <li class="has-submenu">
               <a href="{{ url('my_profile') }}"><i class="mdi mdi-account-multiple "></i>My profile <br></a>
            </li>
            <li class="has-submenu">
               <a href="{{ url('partnerresevationlist') }}"><i class="mdi mdi-account-multiple "></i>Reservations</a>
            </li>
            <li class="has-submenu">
               <!--<a href="{{ url('master_table') }}"><i class="mdi mdi-account-multiple "></i>Master Table</a>-->
            </li>
            <!--<li class="has-submenu">-->
             ...
             <li class="list-inline-item dropdown notification-list john">
               ...
               <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                  <div class="dropdown-item noti-title">
                        <h5 class="text-overflow"><small><center> User </center></small> </h5>
                  </div>
